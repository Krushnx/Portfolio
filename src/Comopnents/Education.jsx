...
function Eduaction()
{
    return(
        <div id='Education' >
            ...
            <Frame clg="PES Modern College of Engineering Pune" duration="2020-2024" image={MCOE} poc={true} degree="Bachelor of Information Technology Engineering" uni="Savitribai Phule Pune University" marks="9.22 GPA" link="https://moderncoe.edu.in/"/>
