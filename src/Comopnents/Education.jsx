...
function Eduaction()
{
    return(
        <div id='Education'>
            ...
            <Frame clg="Keshav Govind Mahavidyalaya Belapur Bk" duration="2018-2020" image="https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y29sbGVnZSUyMGNhbXB1c3xlbnwwfHwwfHw%3D&w=1000&q=80" poc={false} degree="Higer Secondary Schooling (HSC)" uni="Maharashtra State Board" c='red' marks="73.23 %"/>
